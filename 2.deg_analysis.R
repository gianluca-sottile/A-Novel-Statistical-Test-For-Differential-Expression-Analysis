...
dim(topBH)
summary(topBH)
write.csv2(topBonf, file = "mod_t_test_bonf_new.csv")
write.csv2(topBH, file = "mod_t_test_bh_new.csv")
...
write.csv2(sam.obj.pv.Bonf, file = "sam_bonf_new.csv")
write.csv2(sam.obj.pv.BH, file = "sam_bh_new.csv")
...
vpj <- list("hy-test" = names(idPvals05Bonf),
